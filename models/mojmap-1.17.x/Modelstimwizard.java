...
public class Modelstimwizard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "stimwizard"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.5F, -2.0F, -6.5F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-2.5F, -4.0F, -4.5F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(18, 9)
						.addBox(-2.5F, -2.0F, -4.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.5F, -0.5F, 0.3054F, 0.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 9)
				.addBox(-9.0F, -41.0F, -1.0F, 6.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(6.0F, 24.0F, -2.0F));

		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create(),
				PartPose.offset(-2.0F, -7.0F, -1.5F));

		PartDefinition cube_r2 = leg1.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(16, 26).addBox(-1.0F, -10.0F, -0.4F, 2.0F, 17.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, 8.5F, -1.5F, -0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r3 = leg1.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(24, 26).addBox(-1.0F, -8.0F, -1.0F, 2.0F, 17.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = leg2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 23).addBox(-1.0F, -10.0F, -0.4F, 2.0F, 17.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 8.5F, -1.5F, -0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r5 = leg2.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(8, 26).addBox(-1.0F, -8.0F, -1.0F, 2.0F, 17.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 23.0F, -0.5F, 0.1309F, 0.0F, 0.0F));

		PartDefinition arm1 = partdefinition.addOrReplaceChild("arm1", CubeListBuilder.create(),
				PartPose.offset(-3.0F, -15.5F, -1.666F));

		PartDefinition cube_r6 = arm1.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(36, 37).addBox(0.0F, -10.0F, 1.6F, 1.0F, 17.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 9.0F, -1.334F, 0.0873F, 0.0F, 0.1745F));

		PartDefinition cube_r7 = arm1.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(38, 0).addBox(-1.2F, -8.0F, 0.1F, 1.0F, 17.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = arm2.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(32, 25).addBox(-3.0F, -10.0F, 1.6F, 1.0F, 17.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 9.0F, -1.334F, 0.0873F, 0.0F, -0.1745F));

		PartDefinition cube_r9 = arm2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(36, 19).addBox(-1.8F, -8.0F, 0.1F, 1.0F, 17.0F, 1.0F,
						new CubeDeformation(0.0F)),
