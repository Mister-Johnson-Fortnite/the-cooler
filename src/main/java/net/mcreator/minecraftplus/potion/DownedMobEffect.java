...
import net.mcreator.minecraftplus.procedures.DownedOnEffectActiveTickProcedure;
...
public class DownedMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.minecraft_plus.downed";
	}

	@Override
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		DownedOnEffectActiveTickProcedure.execute(entity);
	}
