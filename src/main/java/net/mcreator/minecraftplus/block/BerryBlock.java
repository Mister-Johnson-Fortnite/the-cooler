...
public class BerryBlock extends FlowerBlock {
	public BerryBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(MinecraftPlusModBlocks.BERRY.get(), renderType -> renderType == RenderType.cutout());
	}
}
