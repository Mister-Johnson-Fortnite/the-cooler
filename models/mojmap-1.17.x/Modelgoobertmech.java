...
public class Modelgoobertmech<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "goobertmech"), "main");
	private final ModelPart thatonebit;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition thatonebit = partdefinition.addOrReplaceChild("thatonebit", CubeListBuilder.create()
				.texOffs(0, 42).addBox(-11.0F, -9.0F, -8.5F, 22.0F, 9.0F, 19.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 6.0F, 0.0F));

		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2",
				CubeListBuilder.create().texOffs(142, 111)
						.addBox(-12.0F, -4.0F, -2.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(26, 93)
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1",
				CubeListBuilder.create().texOffs(48, 144)
						.addBox(11.0F, -4.0F, -2.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(142, 59)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(63, 51)
						.addBox(-11.0F, -9.0F, -9.5F, 22.0F, 9.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(20.0F, -6.0F, -30.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-22.0F, -6.0F, -30.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
