...
public class Modelemptymech<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("minecraft_plus", "modelemptymech"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2",
				CubeListBuilder.create().texOffs(142, 111).addBox(18.0F, -6.0F, -2.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(26, 93)
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1",
				CubeListBuilder.create().texOffs(48, 144).addBox(11.0F, -6.0F, -2.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(142, 59)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(63, 51).addBox(-11.0F, -18.0F, -8.5F, 22.0F, 9.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
