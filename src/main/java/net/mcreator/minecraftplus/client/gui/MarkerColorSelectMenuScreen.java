...
public class MarkerColorSelectMenuScreen extends AbstractContainerScreen<MarkerColorSelectMenuMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 196, this.topPos + 3, 0, 0, 100, 100, 100, 100);
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 220, this.topPos + 103, 56, 20, new TextComponent("cancer"), e -> {
			if (true) {
				MinecraftPlusMod.PACKET_HANDLER.sendToServer(new MarkerColorSelectMenuButtonMessage(16, x, y, z));
				MarkerColorSelectMenuButtonMessage.handleButtonAction(entity, 16, x, y, z);
			}
		}));
	}
